...
Source Code
===========
See the source code for method [LightAjaxHandlerController::error](https://github.com/lingtalfi/Light_AjaxHandler/blob/master/Controller/LightAjaxHandlerController.php#L80-L83)
